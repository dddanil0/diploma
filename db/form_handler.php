<?php
	...
	$sql = "INSERT INTO `$dataTable` (`item_type`, `item_name`, `item_characteristic`, `item_balance`, `item_movement`, `item_min_balance`, `item_cost`) VALUES ('$item_type', '$item_name', '$item_characteristic', '$item_balance', '$item_movement', '$item_min_balance', '$item_cost')";
